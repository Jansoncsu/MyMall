            ...
            for(Cart cartItem: cartList){
                ...
                if(product != null){
                    ...
                    if(product.getStock() >= cartItem.getQuantity()){
                        ...
                        cartProductVo.setLimitQuanQuantity(Const.Cart.LIMIT_NUM_SUCCESS);
                    }else{
                        buyLimitCount = product.getStock();
                        cartProductVo.setLimitQuanQuantity(Const.Cart.LIMIT_NUM_FAIL);

                        //购物车中更新有效库存
                        Cart cartForQuantity = new Cart();
                        cartForQuantity.setId(cartItem.getId());   //开始写错了写成userId,要注意
